...
void* (*AVX_memset)(void* dest, int val, size_t numbytes) = AVX_memset_chk;

void* __cdecl AVX_memset_chk(void* dest, int val, size_t numbytes) {
#ifdef     __AVX__        
    if (isAVX())
        AVX_memset = AVX_memset_AVX;
    else
        AVX_memset = memset;
#else
    AVX_memset = AVX_memset_AVX;
#endif
    return AVX_memset(dest, val, numbytes);
}
...
void * memset_128bit_u(void *dest, const __m128i val, size_t len)
{
...
// 32 bytes
void * memset_128bit_32B_u(void *dest, const __m128i val, size_t len)
{
  __m128i *ptr = (__m128i*)dest;
...
// 64 bytes
void * memset_128bit_64B_u(void *dest, const __m128i val, size_t len)
{
  __m128i *ptr = (__m128i*)dest;
...
// 128 bytes
void * memset_128bit_128B_u(void *dest, const __m128i val, size_t len)
{
  __m128i *ptr = (__m128i*)dest;
...
// 256 bytes
void * memset_128bit_256B_u(void *dest, const __m128i val, size_t len)
{
  __m128i *ptr = (__m128i*)dest;
...
void * memset_256bit_u(void *dest, const __m256i val, size_t len)
{
...
// 64 bytes
void * memset_256bit_64B_u(void *dest, const __m256i val, size_t len)
{
  __m256i *ptr = (__m256i*)dest;
...
// 128 bytes
void * memset_256bit_128B_u(void *dest, const __m256i val, size_t len)
{
  __m256i *ptr = (__m256i*)dest;
...
// 256 bytes
void * memset_256bit_256B_u(void *dest, const __m256i val, size_t len)
{
  __m256i *ptr = (__m256i*)dest;
...
// 512 bytes
void * memset_256bit_512B_u(void *dest, const __m256i val, size_t len)
{
  __m256i *ptr = (__m256i*)dest;
...
void * memset_512bit_u(void *dest, const __m512i val, size_t len)
{
...
// 128 bytes
void * memset_512bit_128B_u(void *dest, const __m512i val, size_t len)
{
  __m512i *ptr = (__m512i*)dest;
...
// 256 bytes
void * memset_512bit_256B_u(void *dest, const __m512i val, size_t len)
{
  __m512i *ptr = (__m512i*)dest;
...
// 512 bytes
void * memset_512bit_512B_u(void *dest, const __m512i val, size_t len)
{
  __m512i *ptr = (__m512i*)dest;
...
// 1024 bytes, or 1 kB
void * memset_512bit_1kB_u(void *dest, const __m512i val, size_t len)
{
  __m512i *ptr = (__m512i*)dest;
...
// 2048 bytes, or 2 kB
void * memset_512bit_2kB_u(void *dest, const __m512i val, size_t len)
{
  __m512i *ptr = (__m512i*)dest;
...
void * memset_512bit_4kB_u(void *dest, const __m512i val, size_t len)
{
  __m512i *ptr = (__m512i*)dest;
...
void * AVX_memset_AVX(void *dest, int val, size_t numbytes)
{
  void * returnval = dest;
