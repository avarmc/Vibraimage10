...
#define AVX_alloc(s) _aligned_malloc(((s+63)&(~63)),64)
#define AVX_free(s) _aligned_free(s)

// Calling the individual subfunctions directly is also OK. That's why this header is so huge!


void* __cdecl AVX_memcpy_chk(void* dest, void const* src, size_t numbytes);
void* __cdecl AVX_memset_chk(void* dest, int val, size_t numbytes);

void* __cdecl AVX_memcpy_AVX(void* dest, void const* src, size_t numbytes);
void* __cdecl AVX_memset_AVX(void* dest, int val, size_t numbytes);


extern void * (*AVX_memcpy)(void *dest, void const*src, size_t numbytes);
extern void * (*AVX_memset)(void *dest, int val, size_t numbytes);
...
#ifdef __AVX__
// Unaligned
void * memset_256bit_u(void *dest, __m256i val, size_t len); // 32 bytes
void * memset_256bit_64B_u(void *dest, __m256i val, size_t len); // 64 bytes
void * memset_256bit_128B_u(void *dest, __m256i val, size_t len); // 128 bytes
void * memset_256bit_256B_u(void *dest, __m256i val, size_t len); // 256 bytes
void * memset_256bit_512B_u(void *dest, __m256i val, size_t len); // 512 bytes

// Aligned
void * memset_256bit_a(void *dest, __m256i val, size_t len); // 32 bytes
void * memset_256bit_64B_a(void *dest, __m256i val, size_t len); // 64 bytes
void * memset_256bit_128B_a(void *dest, __m256i val, size_t len); // 128 bytes
void * memset_256bit_256B_a(void *dest, __m256i val, size_t len); // 256 bytes
void * memset_256bit_512B_a(void *dest, __m256i val, size_t len); // 512 bytes

// Aligned, Streaming
void * memset_256bit_as(void *dest, __m256i val, size_t len); // 32 bytes
void * memset_256bit_64B_as(void *dest, __m256i val, size_t len); // 64 bytes
void * memset_256bit_128B_as(void *dest, __m256i val, size_t len); // 128 bytes
void * memset_256bit_256B_as(void *dest, __m256i val, size_t len); // 256 bytes
void * memset_256bit_512B_as(void *dest, __m256i val, size_t len); // 512 bytes
#endif

// AVX512
#ifdef __AVX512F__
// Unaligned
void * memset_512bit_u(void *dest, __m512i val, size_t len); // 64 bytes
void * memset_512bit_128B_u(void *dest, __m512i val, size_t len); // 128 bytes
void * memset_512bit_256B_u(void *dest, __m512i val, size_t len); // 256 bytes
void * memset_512bit_512B_u(void *dest, __m512i val, size_t len); // 512 bytes
void * memset_512bit_1kB_u(void *dest, __m512i val, size_t len); // 1024 bytes
void * memset_512bit_2kB_u(void *dest, __m512i val, size_t len); // 2048 bytes
void * memset_512bit_4kB_u(void *dest, __m512i val, size_t len); // 4096 bytes
// Yes that's a whole page. AVX-512 maxes at 2 kB stored at one time in its registers, though.

// Aligned
void * memset_512bit_a(void *dest, __m512i val, size_t len); // 64 bytes
void * memset_512bit_128B_a(void *dest, __m512i val, size_t len); // 128 bytes
void * memset_512bit_256B_a(void *dest, __m512i val, size_t len); // 256 bytes
void * memset_512bit_512B_a(void *dest, __m512i val, size_t len); // 512 bytes
void * memset_512bit_1kB_a(void *dest, __m512i val, size_t len); // 1024 bytes
void * memset_512bit_2kB_a(void *dest, __m512i val, size_t len); // 2048 bytes
void * memset_512bit_4kB_a(void *dest, __m512i val, size_t len); // 4096 bytes

// Aligned, Streaming
void * memset_512bit_as(void *dest, __m512i val, size_t len); // 64 bytes
void * memset_512bit_128B_as(void *dest, __m512i val, size_t len); // 128 bytes
void * memset_512bit_256B_as(void *dest, __m512i val, size_t len); // 256 bytes
void * memset_512bit_512B_as(void *dest, __m512i val, size_t len); // 512 bytes
void * memset_512bit_1kB_as(void *dest, __m512i val, size_t len); // 1024 bytes
void * memset_512bit_2kB_as(void *dest, __m512i val, size_t len); // 2048 bytes
void * memset_512bit_4kB_as(void *dest, __m512i val, size_t len); // 4096 bytes
#endif
// END MEMSET
